                      ...
                      <button
                        onClick={(e) => {
                          ...
                          if (deletingSourceId === source.id) {
                            console.log('⚠️ NotebookSidebar: Already deleting this source, ignoring click');
                            return;
                          }
                        ...
                        className={`opacity-0 group-hover:opacity-100 transition-opacity p-1 rounded ${
                          deletingSourceId === source.id 
                            ...
                            : 'hover:bg-red-100 dark:hover:bg-red-900/20 text-red-500 hover:text-red-700 dark:text-red-400 dark:hover:text-red-300'
                        }`}
                        title={deletingSourceId === source.id ? "Deleting..." : "Delete source"}
                      >
                        {deletingSourceId === source.id ? (
