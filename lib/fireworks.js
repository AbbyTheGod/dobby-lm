...
- Use bullets for lists, numbers when order matters
- Never use brackets for emphasis (brackets only for citations)
`.trim();
...
Write in short paragraphs with blank lines between them.
